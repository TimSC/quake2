...
def P_ProjectSource (client, point, distance, forward, right, result):
	pass
	"""
...
def PlayerNoise (who, where, type):
	pass
	"""
...
def Weapon_Generic (ent, FRAME_ACTIVATE_LAST, FRAME_FIRE_LAST, FRAME_IDLE_LAST, FRAME_DEACTIVATE_LAST, pause_frames, fire_frames, ent)):
	pass
	"""
...
def weapon_grenade_fire (ent, held):
	pass
	"""
	void weapon_grenade_fire (edict_t *ent, qboolean held)
	{
