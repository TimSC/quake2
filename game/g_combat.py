...
def SpawnDamage (type, origin, normal, damage):
	pass
	"""
...
def T_Damage (targ, inflictor, attacker, dir, point, normal, damage, knockback, dflags, mod):
	pass
	"""
...
def T_RadiusDamage (inflictor, attacker, damage, ignore, radius, mod):
	pass
	"""
